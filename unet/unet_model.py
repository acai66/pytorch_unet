...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.inc = DoubleConv(n_channels, 64 // scale_net)
        self.down1 = Down(64 // scale_net, 128 // scale_net)
        self.down2 = Down(128 // scale_net, 256 // scale_net)
        self.down3 = Down(256 // scale_net, 512 // scale_net)
        factor = 2 if bilinear else 1
        self.down4 = Down(512 // scale_net, 1024 // scale_net // factor)
        self.up1 = Up(1024 // scale_net, 512 // scale_net // factor, bilinear)
        self.up2 = Up(512 // scale_net, 256 // scale_net // factor, bilinear)
        self.up3 = Up(256 // scale_net, 128 // scale_net // factor, bilinear)
        self.up4 = Up(128 // scale_net, 64 // scale_net, bilinear)
        self.outc = OutConv(64 // scale_net, n_classes)
...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True, bilinear=True):
